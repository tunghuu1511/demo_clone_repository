...
<div class="container-fluid">
	<div class="row" style="background-color:#e6ffff;">
		...
		<c:if test="${sessionScope.nd==null }"><h4 style="color:blue;" align="center">Xin Vui Lòng Đăng Nhập Để Thanh Toán</h4></c:if>
		<c:if test="${sessionScope.nd!=null }"><h4 style="color:blue;" align="center"><a href="Trang-Thanh-Toan.jsp">Thanh Toán</a></h4></c:if>
	</div>
</div>